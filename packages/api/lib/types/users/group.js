...
var collection = exports.collection = 'groups';

var schema = exports.schema = new _normalizr.schema.Entity(collection);

var fetch = exports.fetch = function fetch(_ref) {
  var id = _ref.id;
  return (0, _callApi2.default)('groups/' + id, schema);
};

var create = exports.create = function create(body) {
  return (0, _callApi2.default)('groups', schema, { method: 'POST', body: body });
};

var update = exports.update = function update(_ref2, body) {
  var id = _ref2.id;
  return (0, _callApi2.default)('groups/' + id, schema, { method: 'PUT', body: body });
};

var remove = exports.remove = function remove(_ref3) {
  var id = _ref3.id;
  return (0, _callApi2.default)('groups/' + id, schema, { method: 'DELETE' });
};


// WEBPACK FOOTER //
// ./packages/api/lib/types/users/group.js