...
var collection = exports.collection = 'outputDescriptors';
...
var fetch = exports.fetch = function fetch(_ref) {
  ...
  return (0, _callApi2.default)('workflows/' + workflowId + '/actions/' + actionId + '/outputs', schema);
};


// WEBPACK FOOTER //
// ./packages/api/lib/types/workflows/outputDescriptors.js