...
exports.default = DecisionNoResult;
...
function DecisionNoResult(_ref) {
  ...
  return _react2.default.createElement(_workflowEvents2.default, (0, _extends3.default)({}, rest, {
    icon: 'cube',
    title: (0, _signavioI18n2.default)('__decision__ returned no result', {
      decision: event.name
    }),
    event: event
  }));
...
// WEBPACK FOOTER //
// ./packages/cases/lib/events/integrations/dmn/DecisionNoResult.js