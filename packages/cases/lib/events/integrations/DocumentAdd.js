...
exports.default = DocumentAddEvent;
...
function DocumentAddEvent(_ref) {
  ...
  return _react2.default.createElement(_workflowEvents.LogEvent, (0, _extends3.default)({}, rest, {
    event: event,
    icon: 'file',
    title: (0, _signavioI18n2.default)('Document was created')
  }));
}


// WEBPACK FOOTER //
// ./packages/cases/lib/events/integrations/DocumentAdd.js