...
exports.default = SubprocessCompleteEvent;
...
function SubprocessCompleteEvent(_ref) {
  var event = _ref.event,
      rest = (0, _objectWithoutProperties3.default)(_ref, ['event']);
  var subCaseName = event.subCaseName,
  ...
  return _react2.default.createElement(_workflowEvents2.default, (0, _extends3.default)({}, rest, {
    ...
    icon: 'folder-o',
    event: event,
    title: (0, _signavioI18n2.default)('Sub case __case__ completed', {
...
// WEBPACK FOOTER //
// ./packages/cases/lib/events/bpmn/subprocess/Complete.js