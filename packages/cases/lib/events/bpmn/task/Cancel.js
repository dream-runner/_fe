...
exports.default = TaskCancelEvent;
...
function TaskCancelEvent(_ref) {
  ...
  return _react2.default.createElement(_workflowEvents2.default, (0, _extends3.default)({}, rest, {
    ...
    event: event,
    icon: 'cancel',
    title: actor ? (0, _signavioI18n2.default)('__task__ was canceled by __actor__', {
      task: _react2.default.createElement(_components.TaskLink, { task: task, caseId: caseId }),
      actor: _effektifApi.userUtils.name(actor)
    }) : (0, _signavioI18n2.default)('__task__ was canceled', {
      task: _react2.default.createElement(_components.TaskLink, { task: task, caseId: caseId })
    })
  }));
}
...
// WEBPACK FOOTER //
// ./packages/cases/lib/events/bpmn/task/Cancel.js