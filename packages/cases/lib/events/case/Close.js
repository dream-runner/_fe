...
exports.default = CaseCloseEvent;
...
function CaseCloseEvent(_ref) {
  ...
  return _react2.default.createElement(_workflowEvents2.default, (0, _extends3.default)({}, rest, {
    important: true,
    event: event,
    title: (0, _signavioI18n2.default)('This case has been completed.'),
    icon: 'close-case'
  }));
}
...
// WEBPACK FOOTER //
// ./packages/cases/lib/events/case/Close.js