...
exports.default = OrganizationEnabledEvent;
...
function OrganizationEnabledEvent(_ref) {
  ...
  return _react2.default.createElement(_workflowEvents2.default, (0, _extends3.default)({}, rest, {
    event: event,
    title: (0, _signavioI18n2.default)('has enabled __org__.', {
...
// WEBPACK FOOTER //
// ./packages/admin/lib/events/organization/Enabled.js