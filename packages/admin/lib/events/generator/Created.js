...
exports.default = GeneratorCreatedEvent;
...
function GeneratorCreatedEvent(_ref) {
  ...
  return _react2.default.createElement(_workflowEvents2.default, (0, _extends3.default)({}, rest, {
    event: event,
    title: (0, _signavioI18n2.default)('created __type__ generator.', {
...
// WEBPACK FOOTER //
// ./packages/admin/lib/events/generator/Created.js