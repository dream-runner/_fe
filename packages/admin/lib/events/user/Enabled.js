...
exports.default = UserEnabledEvent;
...
function UserEnabledEvent(_ref) {
  ...
  return _react2.default.createElement(_workflowEvents2.default, (0, _extends3.default)({}, rest, {
    event: event,
    title: (0, _signavioI18n2.default)('has enabled __user__.', {
...
// WEBPACK FOOTER //
// ./packages/admin/lib/events/user/Enabled.js