...
exports.default = WorkflowStoppedEvent;
...
function WorkflowStoppedEvent(_ref) {
  ...
  return _react2.default.createElement(_workflowEvents2.default, (0, _extends3.default)({}, rest, {
    event: event,
    icon: 'power',
    title: (0, _signavioI18n2.default)('Signavio Workflow version __version__ stopped', {
      version: version
    })
  }));
}
...
// WEBPACK FOOTER //
// ./packages/admin/lib/events/workflow/Stopped.js